...
final class ExerciseSegmentedCell: UITableViewCell {

    var valueChanged: ParameterBlock<Int>?

    private let segmentedControl = UISegmentedControl(items: [
        "exerciseTabInfo".localized(),
        "exerciseTabHistory".localized()
    ])
    ...
    func configure(with model: ExerciseSegmentedCellModel) {
        selectionStyle = .none
